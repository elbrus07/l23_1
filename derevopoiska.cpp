...
// ============================================================
// Конфигурация отображения и константы
// ============================================================
namespace AppConfig {
...
private:
    ...
    Node* removeRecursive(Node* current, int value) {
        ...
        if (value < current->data)
            ...
            // Случай 3: Два потомка (замена на минимальный из правого)
    ...
    void renderTree(sf::RenderWindow& win, Node* node, 
        ...
        // Небольшая коррекция для центрирования текста
...
public:
    VisualBST() = default;
    ~VisualBST() { /* Для учебного проекта очистка памяти не критична, 
                      но при желании можно добавить рекурсивный деструктор */ }
...
// ============================================================
// Точка входа и обработка интерфейса
// ============================================================
int main() {
